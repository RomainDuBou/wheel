...
const gages = [
    ...
    { text: "Fais un bisou dans le cou du garçon de ton choix pendant 5 secondes", fromGender: "female" },
    { text: "Prends {target} dans tes bras pendant 10 secondes", fromGender: "female" },
    ...
    { text: "Chuchote quelque chose de coquin à l'oreille de {target}", fromGender: "female" },
    ...
    { text: "Fais un bisou sur la joue de {target} en le regardant dans les yeux", fromGender: "female" },
    { text: "Caresse les cheveux de {target} pendant 15 secondes", fromGender: "female" },
    { text: "Fais un câlin à {target} par derrière", fromGender: "female" },
    ...
    { text: "Combien font 2+2 mon grand?", fromGender: "male" },
    { text: "Quelle est la capitale de la France sachant que c'est Paris?", fromGender: "male" },
